    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          {/* Fő cím */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white font-bold leading-tight hero-text-shadow">
            Kürtgyarmat
            <br />
          ...
          {/* Leírás */}
          <p className="text-xl md:text-2xl text-white max-w-3xl mx-auto leading-relaxed hero-text-shadow">
